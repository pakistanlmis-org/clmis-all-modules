        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="page-title row-br-b-wp">Graphical data</h3>

                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <a class="btn btn-sm purple btn_load_dashlet" data-dashlet="a1">1-type / province / month Mismatches Status</a>

                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <a class="btn btn-sm purple btn_load_dashlet" data-dashlet="a2">2 - type /province wise mismatches status</a>

                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <a class="btn btn-sm purple btn_load_dashlet" data-dashlet="a3">3 - only type wise mismatches status</a>
                        ...
                        <div class="row">
                            <div class="col-md-12 my_dash_cols">
                                <div class="col-md-12 ">
                                    <div class="dashlet_graph1" id="dashlet_a1" href='mismatches.php'></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 my_dash_cols">
                                <div class="col-md-12 ">
                                    <div class="dashlet_graph2" id="dashlet_a2" href='mismatches2.php'></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 my_dash_cols">
                                <div class="col-md-12 ">
                                    <div class="dashlet_graph3" id="dashlet_a3" href='mismatches3.php'></div>
                                </div>
                            </div>
                        </div>

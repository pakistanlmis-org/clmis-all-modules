...
<body class="page-header-fixed page-quick-sidebar-over-content" onLoad="doInitGrid()">
    <div class="page-container">
      ...
      $qry = "SELECT
	national_stock.stk_id,
	(CASE WHEN stakeholder.stk_type_id <> 0 THEN 'NGOs'	ELSE	stakeholder.stkname END	) stkname,
	tbl_locations.PkLocID,
	national_stock.item_id,
	national_stock.tr_date TranDate,
	national_stock.quantity Qty,
	itminfo_tab.itm_name,
	tbl_locations.LocName
FROM
	national_stock
...
//$qry = "SELECT
//                tbl_warehouse.stkid,
//                (CASE WHEN stk.stk_type_id <> 0 THEN 'NGOs'	ELSE	stk.stkname END	) AS stkname,
//                    tbl_locations.PkLocID,
//                    itminfo_tab.itm_id,
//                    DATE_FORMAT(
...
//    echo $row['Qty'].':';
    ...
    if(!empty($rules) && $row['stkname']=='NGOs'){
                ...
                <div class="row">
                    <div id="div1" class="col-md-12">
                        ...
                        <table id="USAID_Supported_Stock" border="1" width="100%" cellpadding="0" cellspacing="0" style="" class="table table-bordered table-condensed">
                            <div class="col-md-12">
                                <div class="col-md-11 h4 center">Distribution of USAID supported commodities by PPW – MoNHSR&C</div>
                                <div class="col-md-11 h4 center">After Quota Allocation ( 01-Oct-2016 )</div>
                            ...
                            echo '  <tr>
                                            ...
                                            <th align="center" colspan=""> </th>
                                            <th style="text-align:center" class="info" colspan="'.(($sector=='all')?'8':'7').'">Distribution (01-Oct-2016 to '.date('d-M-Y',strtotime($date)).' )</th>
                                            <th align="center" colspan=""></th>
                                            <th align="center" colspan=""></th>
                                            <th align="center" colspan=""></th>
                                            <th align="center" colspan=""></th>
                            ...
                            echo '  <tr>
                                            ...
                                            <th align="center" colspan="">Allocation by PPW</th>
                                        ';
                                ...
                                foreach ($prov_data as $stk => $prod_data) {
                                    ...
                                    foreach ($prod_data as $prod => $qty) {
                                        ...
                                        foreach ($stk_arr as $k => $stk) {
                                            ...
                                            $class_td = "";
                                            if ($stk != 'Issuance' && $stk != 'Loans/Relocations' ) $class_td = "info";
                                            
                                            echo '<td class="'.$class_td.'" align="right" >';
                                            if ($stk == 'Issuance') {

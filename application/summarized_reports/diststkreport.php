...
if (isset($_REQUEST['month_sel']) && !isset($_REQUEST['go'])) {
    //get selected month
    ...
    //check selected province
    if (isset($_REQUEST['prov_sel']) && !empty($_REQUEST['prov_sel'])) {
        //get selected province
        $sel_prov = $_REQUEST['prov_sel'];
    }
    //check selected province
    ...
    if (!empty($_REQUEST['stk_sel']) && $_REQUEST['stk_sel'] != 'all') {
        ...
        //set filter
        $filter = " AND summary_district.stakeholder_id = '" . $_REQUEST['stk_sel'] . "'";

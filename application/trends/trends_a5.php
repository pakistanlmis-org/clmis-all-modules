...
<div class="widget widget-tabs">    
	...
	<?php 
        $qry = "SELECT
                        ...
                        round(summary_national.soh_national_store/summary_national.avg_consumption,2) as mos
                    FROM
                        summary_national
    ...
    {
        $disp_arr[$row['item_id']][$row['reporting_date']]['mos']           = $row['mos'];
    ...
    //xml for chart
    $xmlstore = '<chart caption="Trendlines - MOS at CWH "  subcaption="" captionfontsize="14" subcaptionfontsize="14" basefontcolor="#333333" basefont="Helvetica Neue,Arial" subcaptionfontbold="0" xaxisname="Day" yaxisname="Consumption" showvalues="1" palettecolors="#0075c2,#1aaf5d,#AF1AA5,#AF711A,#D93636" bgcolor="#ffffff" showborder="0" showshadow="0" showalternatehgridcolor="0" showcanvasborder="0" showxaxisline="1" xaxislinethickness="1" xaxislinecolor="#999999" canvasbgcolor="#ffffff" legendborderalpha="0" legendshadow="0" divlinealpha="100" divlinecolor="#999999" divlinethickness="1" divlinedashed="1" divlinedashlen="1" >';
    ...
    foreach($disp_arr as $itm_id => $itm_data)
    {
        ...
        foreach($months as $k => $month)
        {   
            $val=(!empty($itm_data[$k]['mos'])?$itm_data[$k]['mos']:'0');

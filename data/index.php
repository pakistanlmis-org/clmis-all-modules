                                        ...
                                        <div class="widget-body">
                                            <div class="row">
                                                <div class=" ">
                                                    ...
                                                    <div class="form-group col-xs-4 pull-right"> <p style="margin-top:23px !important; "><a href="index2.php" class="btn default  "><i class="fa fa-external-link  black" style="color:black !important;"></i> Goto facility wise stock analysis</a></p></div>
